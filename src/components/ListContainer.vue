<template>
    <div class="list-container">
        <section class="zhi-list" v-for="section in storiesObj">
            ...
            <article class="list-item" v-for="storie in section.stories">
                <router-link :to="{ name: 'news', params: { id: storie.id }}">
                  <div class="item-preview" v-bind="getImg(storie.images)" :style="{backgroundImage:'url('+ storie.images +')'}"></div>
...
<script>
  export default {
    ...
    methods: {
        ...
        fetchList: function () {
          this.$http.get('api/4/news/before/' + this.getApi(this.dateCount), {}, {
            headers: {
